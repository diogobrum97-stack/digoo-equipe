...
(function() {
  ...
  function addStyle() {
    ...
    s.textContent = `
      ...
      #cc-panel { position:fixed;bottom:80px;right:24px;width:320px;max-height:460px;background:var(--bg2);border:1px solid var(--border2);border-radius:16px;z-index:9989;display:flex;flex-direction:column;box-shadow:0 4px 16px rgba(0,0,0,0.10);font-family:'Inter',sans-serif; }
